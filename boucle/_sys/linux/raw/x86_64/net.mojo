from boucle._sys.linux.raw.ctypes import c_ushort, c_uint, c_uchar
...
# Fields are flattened (sin_addr inlined as __be32) to work around a Mojo
...
# sin6_addr fields are inlined to avoid the nested-struct mojopkg crash.
